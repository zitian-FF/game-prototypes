...
// the unchanged logical world so existing pixel-coordinate math keeps
// meaning what it already means (see orientation.ts / each scene's
// create()). Capped at 2x - many phones report 3x+, and the extra
// sharpness above 2x is barely visible while adding real fill-rate cost.
