...
// meaning what it already means (see each scene's create()). Capped at 2x -
// many phones report 3x+, and the extra sharpness above 2x is barely
// visible while adding real fill-rate cost.
