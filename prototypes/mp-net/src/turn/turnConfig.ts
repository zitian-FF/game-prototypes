...
// The browser's real page origin satisfies the Worker's own origin check
// automatically. Never blocks the connect flow: any failure (network error,
// bad response shape, timeout) resolves to undefined so callers fall back to
// STUN-only / direct connections.
