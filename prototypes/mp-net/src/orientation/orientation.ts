...
export function createOrientationGuard(scene: Phaser.Scene, expected: ExpectedOrientation): void {
  ...
  // which is logical size * PIXEL_RATIO (see main.ts / HostLobbyScene's
  // landscape resize); divide back out so this overlay is laid out in the
  // same logical/CSS pixel space as everything else.
